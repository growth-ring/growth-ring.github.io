...
### <span style="color:#73b2fa">더 편하게 오늘의 할 일을 입력할 수 있어요!</span>
...
### <span style="color:#73b2fa">예정 시간, 남은 할 일, 완료한 시간, 완료한 한 일을 알 수 있어요!</span>
...
### <span style="color:#73b2fa">할 일이 끝나면 휴식 화면으로 넘어가요!</span>
...
### <span style="color:#73b2fa">게스트 유저로 사용이 가능해요!</span>
...
### <span style="color:#73b2fa">테스크 그로우, 어떻게 써야할 지 알려드려요!</span>
...
### <span style="color:#73b2fa">할 일이 종료되면 소리와 알람으로 알려드려요!</span>
...
### <span style="color:#73b2fa">타이머 재생시 favicon과 title로 실시간 시간 확인이 가능해요!</span>
...
### <span style="color:#73b2fa">선택된 할 일을 명확하게 알 수 있어요!</span>
...
### <span style="color:#73b2fa">완료된 할 일을 명확하게 알 수 있어요!</span>
...
### <span style="color:#73b2fa">할 일의 순서를 변경할 수 있어요!</span>
